  ...
  <div class="front-container">
    ...
    <div class="card" style="padding: 20px">
      <div style="margin-bottom: 20px;display: flex;align-items: center">
        ...
        <el-button type="primary" style="margin-left: 20px" @click="handleAdd">充值</el-button>
    ...
    <el-dialog title="用户充值" width="30%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px" style="padding-right: 30px;padding-top: 20px">
        ...
        <el-form-item label="充值方式" prop="type" style="margin-top: 30px">
          <el-radio-group v-model="data.form.type">
            <el-radio value="微信支付"><img style="width: 100px;height: 60px" src="@/assets/imgs/vx.png"></el-radio>
            <el-radio value="支付宝支付"><img style="width: 100px;height: 60px;" src="@/assets/imgs/zfb.png"></el-radio>
          </el-radio-group>
        </el-form-item>
